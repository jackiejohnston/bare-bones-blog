...
#### Customize
The following files have info you can customize such as title tag, footer, headlines, social media links, Twitter widget code, etc.: `app/views/layouts/application.html.erb`, `app/views/layouts/show.html.erb`, `/app/views/posts/_headlines.html.erb` and `app/views/layouts/index.html.erb` files
